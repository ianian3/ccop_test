...
관계 타입
═══════════════════════════════════════════════════════════
Actor 관계: owns_vehicle, drives, belongs_to, controls, has_account, uses_device, accomplice_of, operates, recruits, blackmails
Action 관계: from_account, to_account, caller, callee, accessed_from, accessed_to, sent_msg, received_msg, mentions_account
Evidence 관계: transferred_to, communicated_with, linked_to, registered_to, used_for, targets
Case 관계: involves, eg_used_account, eg_used_phone, eg_used_ip, related_case (Case→Case 유사 사건)
"""
