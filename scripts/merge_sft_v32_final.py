...
OUT_SHAREGPT = os.path.join(BASE, "data", "ccop_v32_final_sharegpt.json")
...
def main():
    ...
    p4 = os.path.join(BASE, "data", "sft_v32_alpaca.jsonl")            # 15,000 건 (신규 V3.2)
    ...
    print(f"\n최종 V3.2 무결점 SFT 데이터 저장 완료: {len(sharegpt_data)}건 -> {OUT_SHAREGPT}")
